...
app.post('/send-media', jsonParser, async (req, res) => {
  ...
  // const media = new MessageMedia(mimetype, attachment, file);

  const media = await MessageMedia.fromUrl(base_url+'file/wa_media/'+file);
